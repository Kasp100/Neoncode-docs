[← Go back](./intro.md#equality)

# Equality

If a type implements the abstract type `equatable`, the `==` operator can be used with it.

## `equatable` abstract type

```neoncode
pkg std;

public abstract type equatable mut
{
